...
function setHardMode()
{
	if (game.data.hardMode)
	{
		...
		AI_TARGET_BARRACKS	= HARD_TARGET_BARRACKS;
		AI_TARGET_FARM		= HARD_TARGET_FARM;
		AI_TARGET_MINE		= HARD_TARGET_MINE;
		AI_UNIT_THRESHOLD	= HARD_UNIT_THRESHOLD;
		AI_SOLDIER_PROPORTION 	= HARD_SOLDIER_PROPORTION;
		AI_KNIGHT_PROPORTION 	= HARD_KNIGHT_PROPORTION;
		AI_CATAPULT_PROPORTION 	= HARD_CATAPULT_PROPORTION;
	...
	else
	{
		...
		AI_TARGET_BARRACKS	= NORMAL_TARGET_BARRACKS;
		AI_TARGET_FARM		= NORMAL_TARGET_FARM;
		AI_TARGET_MINE		= NORMAL_TARGET_MINE;
		AI_UNIT_THRESHOLD	= NORMAL_UNIT_THRESHOLD;
		AI_SOLDIER_PROPORTION 	= NORMAL_SOLDIER_PROPORTION;
		AI_KNIGHT_PROPORTION 	= NORMAL_KNIGHT_PROPORTION;
		AI_CATAPULT_PROPORTION 	= NORMAL_CATAPULT_PROPORTION;
