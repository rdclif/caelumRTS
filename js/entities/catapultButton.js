 ...
 */
game.UI.catapultButton = me.GUI_Object.extend({
    /**
     * constructor
     */
...
//console.log(game.data.x_center + " " + game.data.x_offset + ' ' + game.data.y_center + ' ' + game.data.y_offset);
	    //me.game.world.addChild(me.pool.pull("catapultPlayer", spawnLocation_x, spawnLocation_y));
    ...
    train : function () {
        ...
        this.barracks.callTraining(spawnLocation_x,spawnLocation_y,"catapultPlayer")
    },
